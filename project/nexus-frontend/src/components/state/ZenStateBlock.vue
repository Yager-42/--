...
<template>
  ...
  >
    <div class="grid h-12 w-12 place-items-center rounded-2xl bg-surface-container text-on-surface">
      <div
    ...
    <div class="grid max-w-[34rem] gap-1.5">
      ...
      <h3 class="text-xl font-bold tracking-tight text-on-surface md:text-2xl">{{ resolvedCopy.title }}</h3>
      <p class="text-sm leading-7 text-on-surface-variant">{{ resolvedCopy.body }}</p>
    </div>
