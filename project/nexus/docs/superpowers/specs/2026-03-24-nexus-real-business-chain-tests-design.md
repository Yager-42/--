...
| 点赞与互动 | `InteractionController#react`, `#reactionState`, `#reactionLikers`, `LikeUnlikePersistConsumer`, `PostLikeCountAggregateConsumer`, `PostLikeCount2DbConsumer`, `ReactionSyncConsumer`, `ReactionSyncDLQConsumer` | MySQL, Redis, RabbitMQ, hotkey | 无 | 需要完整互动链路测试 |
