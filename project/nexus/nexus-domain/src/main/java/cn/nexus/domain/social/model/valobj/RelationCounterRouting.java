...
public final class RelationCounterRouting {
    ...
    public static final String RK_POST = "relation.counter.post";
    ...
    public static final String Q_POST = "relation.counter.post.queue";
    ...
    public static final String DLQ_POST = "relation.counter.post.dlq.queue";
    ...
    public static final String RK_POST_DLX = "relation.counter.post.dlx";
