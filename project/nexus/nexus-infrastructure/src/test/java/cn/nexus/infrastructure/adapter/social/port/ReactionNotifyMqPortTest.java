...
@SpringJUnitConfig(ReactionNotifyMqPortTest.TestConfig.class)
class ReactionNotifyMqPortTest {

    @Autowired
    private ReactionNotifyMqPort port;
    ...
    @Import(ReactionNotifyMqPort.class)
