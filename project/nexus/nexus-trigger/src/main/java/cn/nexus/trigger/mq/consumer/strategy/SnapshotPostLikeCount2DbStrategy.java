...
@Slf4j
@Component
public class SnapshotPostLikeCount2DbStrategy implements PostLikeCount2DbStrategy {
    ...
    public SnapshotPostLikeCount2DbStrategy(IReactionRepository reactionRepository,
